...
class UsersCardsPage3 extends StatelessWidget {
  const UsersCardsPage3({super.key});
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: BlocBuilder<CardSingleBloc, CardSingleBlocState>(
                              ...
                              return Container(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Text(
                                      state.cards[index].cardNumber.toString(),
                                      style: const TextStyle(
                                        fontSize: 18,
                                        fontWeight: FontWeight.w400,
                                        color: Colors.white,
